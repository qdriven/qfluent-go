...
import (
	...
	"github.com/qdriven/qfluent-go/internal/app"
	"github.com/qdriven/qfluent-go/internal/log"
)

var logger = log.ZoneLogger("internal/app/handlers")

func HandlerFunc(handler func(aw *app.Wrapper) app.Result) func(c *gin.Context) {
